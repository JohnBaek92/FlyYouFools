...
class Game {
  ...
  gameOver(){
    ...
    this.ctx.fillText(`Gimli Did Not Make It Past The Mines Of Moria`, 210, 55);
    this.ctx.fillText(`Your Score Was ${this.score}`, 380, 100);
    this.ctx.strokeText(`Gimli Did Not Make It Past The Mines Of Moria`, 210, 55);
    this.ctx.strokeText(`Your Score Was ${this.score}`, 380, 100);
  }
